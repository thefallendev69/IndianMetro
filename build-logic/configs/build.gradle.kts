...
dependencies {
    ...
    implementation(libsCatalog.findLibrary("kover-gradle-plugin").get())
}
...
gradlePlugin {
    plugins {
        ...
        register("indianmetroKoverConfigConventions") {
            id = "com.thefallendeveloper.indianmetro.kover-config-conventions"
            implementationClass = "com.thefallendeveloper.indianmetro.configs.KoverConfigConventionsPlugin"
        }
    }
}
